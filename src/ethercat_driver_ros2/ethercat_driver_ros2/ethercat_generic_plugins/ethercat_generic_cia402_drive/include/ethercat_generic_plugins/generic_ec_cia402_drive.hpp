...
protected:
  uint32_t counter_ = 0;
  uint32_t op_cycle_count_ = 0;
  uint32_t non_op_cycles_ = 0;
  ...
  int enable_set_command_interface_index_ = -1;
  int disable_set_command_interface_index_ = -1;
  bool last_fault_reset_command_ = false;
  bool last_enable_set_command_ = false;
  bool last_disable_set_command_ = false;
  bool drive_enable_requested_ = false;
  double last_position_ = std::numeric_limits<double>::quiet_NaN();
  bool position_command_valid_for_enable_ = false;
  bool position_command_accepted_after_enable_ = false;
  double max_position_command_enable_delta_ = 0.005;
