...
ROBOT_ROS_LOCALHOST_ONLY="${ROBOT_ROS_LOCALHOST_ONLY:-0}"
...
cleanup_stale_zeroerr_processes() {
  ...
  local patterns=(
    ...
    "/opt/ros/.*/tf2_ros/static_transform_publisher"
    "/opt/ros/.*/controller_manager/ros2_control_node"
    "/controller_manager/ros2_control_node"
    "ros2_control_node --ros-args"
    "/opt/ros/.*/moveit_ros_move_group/move_group"
    "/opt/ros/.*/rclcpp_components/component_container_mt.*zeroerr_servo_container"
    "component_container_mt.*zeroerr_servo_container"
