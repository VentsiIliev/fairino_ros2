...
class IRobotBackend(ABC):
    ...
    @abstractmethod
    def prepare_ordered_motion_chain(self, segments, start_position, tool=0, user=0, trajectory_optimizer=None): ...
    @abstractmethod
    ...
    @abstractmethod
    def get_motion_passage_status(self, passage_id: str | None = None): ...

    @abstractmethod
    def set_motion_passage_closed(self, passage_id: str, closed: bool): ...
