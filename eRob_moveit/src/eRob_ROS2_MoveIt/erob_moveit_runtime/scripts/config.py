...
DEFAULTS = {
    ...
    'CARTESIAN_SERVO_PUBLISH_RATE_HZ': 50.0,
    'CARTESIAN_SERVO_LINEAR_ACCEL_MM_S2': 0.0,
    ...
    'EXECUTOR_PATH_STOP_DURATION_S': 0.20,
    ...
    'EXECUTOR_POST_UNWIND_JOINT_RATE_LIMIT_RAD_S': 1.2,
    'EXECUTOR_POST_UNWIND_JOINT_ACCEL_LIMIT_RAD_S2': 2.5,
    ...
    'REST_WS_SENSOR_ENABLED': True,
    'REST_WS_SENSOR_HOST': '0.0.0.0',
    'REST_WS_SENSOR_PORT': 5003,
