...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--vel", type=float, default=30.0, help="path velocity percentage")
    parser.add_argument("--acc", type=float, default=30.0, help="path acceleration percentage")
